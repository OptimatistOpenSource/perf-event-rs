use crate::counting::{Config, Counting, CountingGroup};
use crate::infra::WrapResult;
use crate::{BuildError, Builder};

impl Builder {
    pub fn build_counting(&self, cfg: &Config) -> Result<Counting, BuildError> {
        match self {
            ...
            Self {
                ...
                unsafe { Counting::new(cfg, *pid, *cpu, -1, 0) }.map_err(BuildError::SyscallFailed)
            }
        }
    }
